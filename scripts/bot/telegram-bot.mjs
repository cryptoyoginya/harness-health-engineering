...
const INTRO = [
  'Это вход в твой health-харнесс — личную систему, которая превращает сырьё твоих дней в причинные выводы: какие рычаги реально двигают твою жизнь, а какие метрики просто красиво растут, ничего не меняя. Не трекер ради цифр — система качества жизни, где тело лишь прибор.',
  '',
  ...
  '',
  'Шли как удобно, можно вперемешку:',
  '• текстом',
  '• голосовым — расшифрую прямо на устройстве (аудио никуда не уходит)',
  '• селфи — коплю в локальный визуальный дневник; динамику кожи/лица/отёков потом смотрит агент по запросу «посмотри селфи за неделю» (описывает изменения, без диагнозов; тревожное — к специалисту)',
  '',
  ...
  '',
  'Чем живее и честнее детали, тем точнее потом видно связь «жизнь → тело» и тем сильнее выводы. Recovery, HRV и сон Whoop тянет сам по утрам — дублировать не надо; утром пришлю короткий бриф по телу.',
  '',
